...
const Bar = () => {
    return (
        <div className="bar">
<ul>
  <li> <img src={order}></img> <Link to="order" smooth={true} duration={1000}>ORDER</Link></li>
  ...
  <li><img src={gift}></img> <Link to="giftbox" smooth={true} duration={1000}>GIFT BOXES</Link></li>
